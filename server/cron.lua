...
RegisterServerEvent('voidrp-base:registerPeriodCron')
AddEventHandler('voidrp-base:registerPeriodCron', function(cron, time)
    if cron == nil then
        cron = function()
...
RegisterServerEvent('voidrp-base:registerTimeCron')
AddEventHandler('voidrp-base:registerTimeCron', function(cron, time)
    local job = {}
